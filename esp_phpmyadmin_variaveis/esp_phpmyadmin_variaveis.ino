...
#define LED_01 16 // Defines GPIO 13 as LED_1. //checklist feito

#define LED_02 17 // Defines GPIO 12 as LED_2. //tempo de troca das pecas

#define LED_03 18 // Defines GPIO 12 as LED_2. //checklist nao feito
...
void control_LEDs() {
  ...
  if(strcmp(myObject["LED_03"], "ON") == 0)   {digitalWrite(LED_03, HIGH);  Serial.println("LED 02 ON"); }
  if(strcmp(myObject["LED_03"], "OFF") == 0)  {digitalWrite(LED_03, LOW);   Serial.println("LED 02 OFF");}
...
void setup() {
  ...
  digitalWrite(LED_03, HIGH); //--> Turn on LED_03.
  ...
  digitalWrite(LED_03, LOW); //--> Turn off Led LED_03.
